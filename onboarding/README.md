...
1. **[01-PREREQUISITES.md](01-PREREQUISITES.md)** — install Python and `omaib-contracts`
2. **[02-CREATE-ADAPTER.md](02-CREATE-ADAPTER.md)** — run `omaib-init-adapter` and fill in the files
3. **[04-VALIDATION.md](04-VALIDATION.md)** — run `omaib-validate-adapter` until Gate 1 passes
4. **[05-CI-SETUP.md](05-CI-SETUP.md)** — copy the workflow to `.github/workflows/`
5. **[06-REGISTER.md](06-REGISTER.md)** — open the registration issue
...
- [omaib-docs Discussions](https://github.com/omaib/omaib-docs/discussions) — peer questions
